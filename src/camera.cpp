...
static void multiply(float matrix[4][4], const float a[4][4], const float b[4][4]) {
	float c[4][4];
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			c[i][j] = 0.0f;
...
static void translate(float matrix[4][4], const float x, const float y, const float z) {
	matrix[0][0] = 1.0f;
	matrix[0][1] = 0.0f;
	matrix[0][2] = 0.0f;
	matrix[0][3] = 0.0f;
...
static void rotate(float matrix[4][4], const float x, const float y, const float z,
				   const float angle) {
...
static void ortho(float matrix[4][4], const float left, const float right, const float bottom,
...
static void frustum(float planes[6][4], const float a[4][4]) {
