...
static SDL_GPUGraphicsPipeline* load_sky(const SDL_GPUTextureFormat format) {
...
static SDL_GPUGraphicsPipeline* load_shadow(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
...
static SDL_GPUGraphicsPipeline* load_opaque(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
...
static SDL_GPUGraphicsPipeline* load_ssao(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
...
static SDL_GPUGraphicsPipeline* load_composite(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
		.vertex_shader = load("fullscreen.vert", 0, 0),
...
static SDL_GPUGraphicsPipeline* load_transparent(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
...
static SDL_GPUGraphicsPipeline* load_raycast(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
...
static SDL_GPUGraphicsPipeline* load_ui(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
		.vertex_shader = load("fullscreen.vert", 0, 0),
...
static SDL_GPUGraphicsPipeline* load_random(const SDL_GPUTextureFormat format) {
	SDL_GPUGraphicsPipelineCreateInfo info = {
		.vertex_shader = load("fullscreen.vert", 0, 0),
...
bool pipeline_init(SDL_GPUDevice* handle, const SDL_GPUTextureFormat format) {
	assert(handle);
	assert(format);
	device = handle;
